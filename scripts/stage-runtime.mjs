...
if (!wuxianpiRoot || !serviceManager || !node) {
  throw new Error("Usage: stage-runtime.mjs --wuxianpi DIR --service-manager FILE --node FILE [--output DIR] [--platform win32] [--arch x64]");
}
...
for (const name of ["wuxianpi-normal", "wuxianpi-repair", "service-manager", "node"]) {
